...
See `docs/PA_GENERATIVE_SIMULATOR.md`, `docs/validation/PA_GENERATIVE_CANONICAL_BACKTEST_2026-08-16.md`, and `docs/validation/PA_GENERATIVE_IMPLEMENTATION_CANDIDATE_REPORT_2026-08-16.md`.
